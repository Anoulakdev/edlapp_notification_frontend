...
interface DeleteCutpowerModalProps {
  open: boolean;
  onClose: () => void;
...
export function DeleteCutpowerModal({ open, onClose, onDelete, selectedDoc }: DeleteCutpowerModalProps) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      console.error("Failed to delete cutpower doc:", err);
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <Modal open={open} onClose={onClose} title="ລົບຂໍ້ມູນແຈ້ງການຕັດໄຟ" size="sm">
