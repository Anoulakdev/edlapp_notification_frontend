...
interface DeleteProblemdocModalProps {
  open: boolean;
  onClose: () => void;
...
export function DeleteProblemdocModal({ open, onClose, onDelete, selectedDoc }: DeleteProblemdocModalProps) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      console.error("Failed to delete problem doc:", err);
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <Modal open={open} onClose={onClose} title="ລົບຂໍ້ມູນແຈ້ງບັນຫາ" size="sm">
