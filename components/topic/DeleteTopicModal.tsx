...
export function DeleteTopicModal({ open, onClose, onDelete, selectedDoc }: DeleteTopicModalProps) {
  ...
  return (
    <Modal open={open} onClose={onClose} title="ລົບຫົວຂໍ້ການສົນທະນາ" size="sm">
