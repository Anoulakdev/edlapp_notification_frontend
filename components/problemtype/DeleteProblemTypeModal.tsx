...
interface DeleteProblemTypeModalProps {
  open: boolean;
  onClose: () => void;
...
export function DeleteProblemTypeModal({ open, onClose, onDelete, selectedDoc }: DeleteProblemTypeModalProps) {
  ...
  return (
    <Modal open={open} onClose={onClose} title="ລົບຂໍ້ມູນປະເພດບັນຫາ" size="sm">
