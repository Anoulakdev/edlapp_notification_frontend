...
export function DeleteRoleModal({ open, onClose, onDelete, selectedDoc }: DeleteRoleModalProps) {
  ...
  return (
    <Modal open={open} onClose={onClose} title="ລົບຂໍ້ມູນສິດຜູ້ໃຊ້ງານ" size="sm">
