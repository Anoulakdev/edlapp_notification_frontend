...
interface DeleteSourceTypeModalProps {
  open: boolean;
  onClose: () => void;
...
export function DeleteSourceTypeModal({ open, onClose, onDelete, selectedDoc }: DeleteSourceTypeModalProps) {
  ...
  return (
    <Modal open={open} onClose={onClose} title="ລົບຂໍ້ມູນຊ່ອງທາງຮັບແຈ້ງ" size="sm">
