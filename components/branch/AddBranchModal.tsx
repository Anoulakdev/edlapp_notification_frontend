...
export function AddBranchModal({ open, onClose, onRefresh }: AddBranchModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success("ເພີ່ມຂໍ້ມູນສາຂາແຂວງສຳເລັດ");
      onRefresh();
      onClose();
    } catch (err: any) {
  ...
  return (
    <Modal open={open} onClose={onClose} title="ເພີ່ມຂໍ້ມູນສາຂາແຂວງ" size="md">
