...
export function DeleteBranchModal({ open, onClose, onDelete, selectedDoc }: DeleteBranchModalProps) {
  ...
  return (
    <Modal open={open} onClose={onClose} title="ລົບຂໍ້ມູນສາຂາແຂວງ" size="sm">
