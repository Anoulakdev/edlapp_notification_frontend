...
interface DeleteRegistermeterModalProps {
  open: boolean;
  onClose: () => void;
...
export function DeleteRegistermeterModal({ open, onClose, onDelete, selectedDoc }: DeleteRegistermeterModalProps) {
  ...
  return (
    <Modal open={open} onClose={onClose} title="ລົບຂໍ້ມູນຂໍໝໍ້ນັບໄຟໃໝ່" size="sm">
