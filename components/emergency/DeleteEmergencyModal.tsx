...
export function DeleteEmergencyModal({ open, onClose, onDelete, selectedDoc }: DeleteEmergencyModalProps) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      console.error("Failed to delete emergency doc:", err);
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <Modal open={open} onClose={onClose} title="ລົບຂໍ້ມູນແຈ້ງການມອດໄຟສຸກເສີນ" size="sm">
