...
interface DeleteTurnoffModalProps {
  open: boolean;
  onClose: () => void;
...
export function DeleteTurnoffModal({ open, onClose, onDelete, selectedDoc }: DeleteTurnoffModalProps) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      console.error("Failed to delete turnoff doc:", err);
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <Modal open={open} onClose={onClose} title="ລົບເອກະສານແຈ້ງການມອດໄຟ" size="sm">
